...
namespace EnhancedHierarchy {
    ...
    internal static partial class EnhancedHierarchy {
        ...
        private static void OnItemGUI(int id, Rect rect) {
            ...
            using(ProfilerSample.Get("Enhanced Hierarchy"))
                try {
                    ...
                    if(IsFirstVisible && ReflectionHelper.HierarchyArea.Supported) {
                    ...
                    if(ReflectionHelper.IconWidthSupported)
                        ReflectionHelper.IconWidth = Preferences.DisableNativeIcon ? 0 : 16;
        ...
        private static void DrawHover() {
            if(ReflectionHelper.NativeHierarchyHoverTintSupported) {

                if(IsFirstVisible && IsRepaintEvent)
                    ReflectionHelper.NativeHierarchyHoverTint = Preferences.HoverTintColor;
            ...
            if(IsFirstVisible && ReflectionHelper.NativeHierarchyHoverTintSupported)
        ...
        private static void DrawTree(Rect rect) {
            ...
            using(new GUIColor(CurrentColor, Preferences.TreeOpacity)) {
                ...
                if(ReflectionHelper.HierarchyArea.Supported)
                    indent = ReflectionHelper.HierarchyArea.IndentWidth;
